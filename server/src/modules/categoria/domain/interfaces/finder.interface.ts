...
interface IFinderRepository {
   ...
   * @returns {Promise<Domain | null>} Una promesa que resuelve con el objeto del dominio o null si no se encuentra.
   * @throws {ServerError} Si la consulta a la base de datos falla.
  */
  getCategoriaId(id: number): Promise<Domain | null>;
   ...
   * @throws {ServerError} Si la consulta a la base de datos falla.
  */
  getCategoriaNombre(nombre: string): Promise<Domain | null>;
};

export default IFinderRepository;