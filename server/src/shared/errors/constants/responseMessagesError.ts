export const ResponseMessagesError = {
  ...
  UNPROCESSABLE_ENTITY:
    "Los datos enviados no son válidos. Por favor, revise y corrija los errores.",
...
export type ResponseMessagesErrorType =
  (typeof ResponseMessagesError)[keyof typeof ResponseMessagesError];
